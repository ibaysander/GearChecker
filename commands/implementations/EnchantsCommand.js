...
class EnchantsCommand extends BaseCommand {
    constructor() {
        super(
            Commands.ench,
            'Displays which enchants are missing from the player\'s currently equipped items',
            '!ench [player_name] [realm?]'
        );
    }
    ...
    async execute(msg, args) {
        ...
        try {
            ...
            await msg.reply(character.Enchants);
        } catch (error) {
